...
const Navbar = () => {
    ...
    return (
        <div className= {shadow ? "fixed w-full h-20 z-[100] shadow-xl bg-[#ecf0f3]" : "fixed w-full h-20 z-[100] bg-[#ecf0f3]" }>
                ...
                <div className={!nav ? "fixed left-0 top-0 h-screen w-[75%] sm:w-[60%] md:w-[45%] p-4 bg-[#ecf0f3] ease-in duration-500" : "md:hidden fixed left-[-100%] top-0 p-4 bg-[#ecf0f3] ease-in duration-500"}>
                    ...
                    <div className="py-3 flex flex-col">
                        <ul className="uppercase">
                            <Link href="/#home">
                                <li onClick={() => setNav(false)} className="py-3 px-2 text-sm">Home</li>
                            </Link>
                            <Link href="/#about">
                                <li onClick={() => setNav(false)} className="py-3 px-2 text-sm">About</li>
                            </Link>
                            <Link href="/#skills">
                                <li onClick={() => setNav(false)} className="py-3 px-2 text-sm">Skills</li>
                            </Link>
                            <Link href="/#projects">
                                <li onClick={() => setNav(false)} className="py-3 px-2 text-sm">Projects</li>
                            </Link>
                            <Link href="/#contact">
                                <li onClick={() => setNav(false)} className="py-3 px-2 text-sm">Contact</li>
                            </Link>
                        </ul>
